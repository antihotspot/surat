											...
											<div class="col-md-6 col-lg-6">
												...
												<div class="form-check">
													...
													<label class="form-radio-label">
														<input class="form-radio-input" type="radio" name="jekel" value="Laki-Laki" <?= ($jekel == 'Laki-Laki') ? 'checked' : '' ?>>
														<span class="form-radio-sign">Laki-Laki</span>
													</label>
													<label class="form-radio-label ml-3">
														<input class="form-radio-input" type="radio" name="jekel" value="Perempuan" <?= ($jekel == 'Perempuan') ? 'checked' : '' ?>>
