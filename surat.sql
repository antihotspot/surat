...
--
-- Host: localhost
-- Generation Time: Jul 31, 2024 at 03:40 AM
...
(11, '0987', '2024-07-25 04:21:11', '0987_.jpg', '0987_.jpg', 'Minta izin', 'Surat sedang dalam proses cetak', 'LAINNYA', 2, '2024-07-28'),
(12, '0987', '2024-07-25 04:30:54', '0987_.jpg', '0987_.jpg', 'Konser', 'Surat sedang dalam proses cetak', 'LAINNYA', 2, '2024-07-28');
...
(53, '0987', '2024-07-10 08:25:18', '0987 - Karina Aespa_ktp_1721015440.jpg', '0987 - Karina Aespa_kk_1721015440.jpg', 'Konser', 'TIDAK MAMPU', 'Surat dicetak, bisa diambil!', 3, '2024-07-15'),
...
(61, '777', '2024-07-25 08:18:07', 'kkkk', 'kkk', 'kkkk', 'TIDAK MAMPU', 'Surat sedang dalam proses cetak', 2, '2024-07-25');
...
(10, '0987', '2024-07-15 03:55:53', '', '', 'Tahu Walik', 'Minta izin', 'Surat sedang dalam proses cetak', 'USAHA', 2, '2024-07-31'),
(14, '0987', '2024-07-30 06:50:33', '0987_.jpg', '0987_.jpg', 'Gudang Garam', 'Konser', 'Data sedang diperiksa oleh Staf', 'USAHA', 1, NULL);
...
('0987', '0987', 'Pemohon', 'Karina Aespa', '2002-01-24', 'Banyuwangi', 'Laki-Laki', 'Kristen', ' Banyuwangi', '082334099575', 'Kerja'),
...
('555', '3', 'Lurah', 'Wisata', '2024-07-04', 'KPU KOTA MOJOKERTO', 'Laki-Laki', NULL, 'Kutorejo', NULL, 'Kerja'),
('5678', '5678', 'Pemohon', 'NCT', '2024-07-18', 'Banyuwangi', 'Laki-Laki', NULL, NULL, NULL, NULL),
('777', '12345', 'Pemohon', 'a', '2021-10-20', 'oke', 'Laki-Laki', '', 'x', '', 'Sekolah'),
('8767996678899898', 'nn', 'Pemohon', 'Rizqi Amalia kk', '2024-07-19', 'll', 'Laki-Laki', NULL, NULL, NULL, NULL),
...
CREATE TABLE `lembar_disposisi` (
  ...
  `no_agenda` int(50) NOT NULL,
  `no_surat` varchar(100) NOT NULL,
  `tanggal_surat` date NOT NULL,
  `jam_diterima` time NOT NULL,
...
INSERT INTO `lembar_disposisi` (`id_disposisi`, `nik`, `dari`, `no_agenda`, `no_surat`, `tanggal_surat`, `jam_diterima`, `perihal`, `tanggal_masuk`, `catatan`, `status`, `acc`) VALUES
(1, '0987', 'Bawaslu Kota Mojokerto', 678, '223/PM.00.02/K.JI-35/08/2023', '2024-07-09', '21:16:21', 'Imbauan', '2024-07-10', 'Telah ditinjau dan akan dicetak', 2, '2024-07-10');
...
--
ALTER TABLE `lembar_disposisi`
  ADD CONSTRAINT `lembar_disposisi_ibfk_1` FOREIGN KEY (`nik`) REFERENCES `data_user` (`nik`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
